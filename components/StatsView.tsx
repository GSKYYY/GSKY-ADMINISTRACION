...
const checkCategory = (o: Order, cat: ServiceFilter): boolean => {
    ...
    const hasEmbroidery = o.items.some(i => i.type && i.type.toLowerCase().includes('bordado')) || model.includes('bordado');
    const hasSublimation = o.items.some(i => i.type && i.type.toLowerCase().includes('sublima')) || model.includes('sublima');
    const hasSewing = o.items.some(i => i.type && (i.type.toLowerCase().includes('ruedo') || i.type.toLowerCase().includes('costura') || i.type.toLowerCase().includes('ajuste'))) || model.includes('costura');
