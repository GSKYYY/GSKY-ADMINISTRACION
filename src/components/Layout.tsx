...
import { LayoutDashboard, Users, Scissors, BarChart3, Menu, Share2, Sparkles, Trash2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col md:flex-row text-gray-100 font-sans selection:bg-primary-500/30">
      ...
      <aside className="hidden md:flex flex-col w-72 glass-panel h-screen sticky top-0 print:hidden border-r border-white/5 z-20">
        ...
        <nav className="flex-1 px-6 space-y-3 overflow-y-auto custom-scrollbar">
          ...
          <NavItem view="ai" icon={Sparkles} label="Inteligencia Art." />
          <NavItem view="trash" icon={Trash2} label="Papelera" />
        </nav>
